...
class Summary():
    ...
    def createDataset(self, method=["lines", "columns"]):
        ...
        begin = time(); dicFeat1 = self.thematicRatioFeat(); end = time(); print(end-begin)
        begin = time(); dicFeat2 = self.sentPosFeat(); print('sentPosFeat'); end = time(); print(end-begin)
        begin = time(); dicFeat3 = self.sentLenFeat(); print('sentLenFeat');
        begin = time(); dicFeat4 = self.sentParaPosFeat(); print('sentParaPosFeat'); end = time(); print(end-begin)
        begin = time(); dicFeat5 = self.properNounsFeat(); print('properNounsFeat'); end = time(); print(end-begin)
        begin = time(); dicFeat6 = self.sentNumeralsFeat(); print('sentNumeralsFeat'); end = time(); print(end-begin)
        begin = time(); dicFeat7 = self.properNounsFeat() #TODO named entities
        begin = time(); dicFeat8 = self.tf_isfFeat(); print('tf_isfFeat'); end = time(); print(end-begin)
        begin = time(); dicFeat9 = self.centroidSimFeat(); print('centroidSimFeat'); end = time(); print(end-begin)
